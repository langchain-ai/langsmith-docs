...
:::note beta
This feature is currently in beta. Please reach out to our team at sales@langchain.dev if you are interested in leveraging this option.
:::
...
- **You must be on AWS or GCP.** We do not support Azure at this time as we require S3 or GCS for blob storage. If you would like to use private endpoints, ensure that your VPC is in a ClickHouse Cloud supported [region](https://clickhouse.com/docs/en/cloud/reference/supported-regions).
