...
- _Retention Periods:_ You can configure system-wide retention period for shortlived and longlived traces. Once configured, you can manage the retention on each project level as well an organization level default between longlived and shortlived.
