...
Traces can will also be auto-upgraded retention levels based on certain actions or run rule applications. For more details on Data Retention, take a look at the [data retention guide](/concepts/usage_and_billing/data_retention_billing).
