...
However, you can configure LangSmith to use an external Postgres database (_strongly recommended in a production setting_). By configuring an external Postgres database, you can more easily manage backups, scaling, and other operational tasks for your database.
