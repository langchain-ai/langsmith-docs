...
1. Api Key Salt
   ...
   ```
1. Configuration
   1. There are several configuration options that you can set in the `langsmith_config.yaml` file. You can find more information on the available configuration options in the [Configuration](/self_hosting/installation/configuration) section.
...
2. Set the appropriate values in the `langsmith_config.yaml` file. You can find the available configuration options in the [Configuration](/self_hosting/installation/configuration) section.
