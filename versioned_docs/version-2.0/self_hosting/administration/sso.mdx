...
- You must provide the OIDC and email scopes to LangSmith. We use these to fetch the necessary user information and email for your users.
...
TODO: Add instructions for configuring OAuth SSO for specific providers
