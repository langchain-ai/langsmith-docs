...
However, you can configure LangSmith to use an external Redis instance(strongly recommended in a production setting). By configuring an external Redis instance, you can manage backups, scaling, and other operational tasks for your Redis instance.
