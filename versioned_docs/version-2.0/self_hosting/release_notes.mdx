...
## Week of Jun, 2024 - LangSmith v0.6
...
- Reminder: **API keys prefixed with `ls__` will NO LONGER work as of LangSmith Helm release v0.7 to be released on or after July 1, 2024.**
- v0.1.20 or later of the `langchainhub` sdk package is required when iteracting with the LangSmith Hub prompt repository.

### New Features

- Dataset splits for evaluation and filtering/editing dataset examples. See: [https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#datasetsplits](https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#datasetsplits)
- You can now run multiple repetitions of your experiment in LangSmith. See: [https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#repetitions](https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#repetitions)
- Off-the-shelf online evaluator prompts to catch bad retrieval and hallucinations for RAG. See: [https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#onlineevaluatorprompts]](https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#onlineevaluatorprompts)
- Manage private prompts without a handle. See: [https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#privateprompts](https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#privateprompts)
- Workspaces in LangSmith for improved collaboration & organization. See: [https://blog.langchain.dev/week-of-6-10-langchain-release-notes/#workspaces](https://blog.langchain.dev/week-of-6-10-langchain-release-notes/#workspaces)
- Enter the playground from scratch instead of from a trace or a prompt. See: [https://blog.langchain.dev/week-of-6-10-langchain-release-notes/#playground-from-scratch](https://blog.langchain.dev/week-of-6-10-langchain-release-notes/#playground-from-scratch)
- Variable mapping for online evaluator prompts. See: [https://blog.langchain.dev/week-of-6-10-langchain-release-notes/#variable-mapping](https://blog.langchain.dev/week-of-6-10-langchain-release-notes/#variable-mapping)
- Custom Model support in Playground. See: [https://docs.smith.langchain.com/how_to_guides/playground/custom_endpoint](https://docs.smith.langchain.com/how_to_guides/playground/custom_endpoint)
...
- Reduced run rule interval from 5 minutes to 1 minute
