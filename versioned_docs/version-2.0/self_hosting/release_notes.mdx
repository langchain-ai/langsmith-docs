...
- Off-the-shelf online evaluator prompts to catch bad retrieval and hallucinations for RAG. See: [Learn More...](https://blog.langchain.dev/week-of-5-27-langchain-release-notes/#onlineevaluatorprompts)
