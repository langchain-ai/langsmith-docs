...
| [Contact us to learn more](https://airtable.com/app8ZrGLtHAtFVO1o/pagfLAmdTz4ep7TGu/form)                                                                                                                                                                 | <ul><li>Free for 1 user</li><li>5,000 free traces per month</li><li>Additional traces billed starting @ 0.05¢/trace</li></ul>                                                   | <ul><li>$39/user</li><li>10,000 free traces per month</li><li>Additional traces billed starting @ 0.05¢/trace</li></ul>                                                                             | Custom                                                                                                                                                                                                                                                                                                                      |
...
| <b>Trace Details</b>                        |                                                                                                              |                                                                                                               |                                                           |
| Traces<sup>2</sup>                          |                      First 5k traces per month for free<br />0.05¢ per trace thereafter                      |                      First 10k traces per month for free<br />0.05¢ per trace thereafter                      |                          Custom                           |
| Extended Retention Upgrades<sup>2</sup>     | First 5k extended retention upgrades per month for free<br />0.45¢ per extended retention upgrade thereafter | First 10k extended retention upgrades per month for free<br />0.45¢ per extended retention upgrade thereafter |                          Custom                           |
| <b>Ingest Limits</b>                        |                                                                                                              |                                                                                                               |                                                           |
...
the [Plans and Billing](https://smith.langchain.com/settings/payments) settings page.
...
We have our SOC 2 Type I certification and are GDPR compliant. We are in our SOC 2 Type II observation period and expect to receive our certification in July. We will update this page accordingly. You can request more information about our security policies and posture at trust.langchain.com.
