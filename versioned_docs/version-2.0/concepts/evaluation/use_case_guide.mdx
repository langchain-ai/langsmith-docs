...
| ---------------------------------- | ----------------------------------------- | --------------- | ------------------------------------------------------------------------------------- | ----------------- |
| Retrieved documents precision | Any retrieved docs irrelevant to question | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-document-relevance)   | No                |
| Retrieved documents recall    | Retrieved docs address question           | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-document-relevance)   | No                |
| Answer faithfulness           | Answer hallucinations vs retrieved docs   | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-answer-hallucination) | No                |
| Answer relevance              | Answer relevant to retrieved docs         | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-answer-hallucination) | No                |
| Answer helpfulness            | Answer helpful to address question        | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-answer-helpfulness)   | No                |
| Answer correctness            | Is answer correct relative to reference   | No              | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-answer-vs-reference)  | No                |
...
| Use Case                             | Detail                                  | Reference-free? | LLM-as-judge?                                                                   | Pairwise relevant |
| ------------------------------------ | --------------------------------------- | --------------- | ------------------------------------------------------------------------------- | ----------------- |
| Factual accuracy | Is summary consistent w/ source         | Yes             | Yes - [prompt](https://smith.langchain.com/hub/rlm/summary-accurancy-evaluator) | Yes               |
| Faithfulness     | Does summary contain hallucinations     | Yes             | Yes - [prompt](https://smith.langchain.com/hub/rlm/summary-accurancy-evaluator) | Yes               |
| Relevance        | Is summary relevant to source           | Yes             | Yes - [prompt](https://smith.langchain.com/hub/rlm/summary-accurancy-evaluator) | Yes               |
| Helpfulness      | Is summary relevant to task / user need | Yes             | Yes - [prompt](https://smith.langchain.com/hub/rlm/summary-accurancy-evaluator) | Yes               |
| Insightfulness   | Is summary relevant to task / user need | Yes             | Yes - [prompt](https://smith.langchain.com/hub/rlm/summary-accurancy-evaluator) | Yes               |
...
| Use Case                            | Detail                          | Reference-free?         | LLM-as-judge?                                               | Pairwise relevant |
| ----------------------------------- | ------------------------------- | ----------------------- | ----------------------------------------------------------- | ----------------- |
| Criteria  | Tag if specific criteria is met | Yes                     | Yes - [prompt](https://smith.langchain.com/hub/rlm/tagging) | No                |
