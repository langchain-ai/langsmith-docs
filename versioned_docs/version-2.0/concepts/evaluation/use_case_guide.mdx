...
| ------------------- | ------------------------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------- | ----------------- |
| Answer precision    | Fraction of docs in the context that are used to support the answer | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-context-precision)    | No                |
| Answer recall       | Fraction of sentences in answer that are supported by context       | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/rag-context-recall)       | No                |
...
| Chain comparison    | Compare the output of different RAG chains                          | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/pairwise-evaluation-rag)  | Yes               |
...
| Use Case         | Detail                                      | Reference-free? | LLM-as-judge?                                                                                 | Pairwise relevant |
| ---------------- | ------------------------------------------- | --------------- | --------------------------------------------------------------------------------------------- | ----------------- |
| Factual accuracy | Is summary consistent w/ source             | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/summary-accurancy-evaluator)      | Yes               |
| Faithfulness     | Does summary contain hallucinations         | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/summary-hallucination-evaluator)  | Yes               |
| Relevance        | Is summary relevant to source               | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/summary-relevance-evaluator)      | Yes               |
...
| Insightfulness   | Is summary insightful relative to user need | Yes             | Yes - [prompt](https://smith.langchain.com/hub/langchain-ai/summary-insightfulness-evaluator) | Yes               |
