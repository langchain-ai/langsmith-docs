...
:::note
Please ensure you are using the python SDK with version >= 1.100 or the typescript SDK with version >= 1.43
:::

For copy and paste convenience, you can find the similar code snippets to the ones shown in the screenshot above
here:
