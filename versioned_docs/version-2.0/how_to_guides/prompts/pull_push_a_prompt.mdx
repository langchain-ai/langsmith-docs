...
# deprecated: Push/pull a prompt

:::important
This guide is out of date, but the functionality is still supported. Please see the updated guide [here](/how_to_guides/prompts/manage_prompts_programatically).
The `langchainhub` package is now deprecated. All functionality going forward will live in the `langsmith` package.
:::
