...
Navigate to the "Prompts" section in the left-hand sidebar.
...
Regular prompts are for generating text, while chat prompts are for conversational models.
Structured prompts are for specifying the structure of the model's output.

![](../static/pick_prompt_type.png)

## Write your prompt in the prompt playground
