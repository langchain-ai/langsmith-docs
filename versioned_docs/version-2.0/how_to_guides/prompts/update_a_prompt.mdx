...
Navigate to the "Prompts" section in the left-hand sidebar and click on the prompt you want to edit.
...
When you commit changes to a prompt, a new version of the prompt is created. You can view all historical versions by clicking the "Commit" tab in the prompt view.
