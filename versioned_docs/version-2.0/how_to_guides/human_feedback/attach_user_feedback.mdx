...
The ability to observe user feedback along with trace data can be very powerful to drill down into the most interesting data-points, then send those data-points for further review, automatic evaluation, or even datasets.
