...
only for our self service billing plans. 
:::
...
To set up billing for your LangSmith organization, head to the
[Usage and Billing](https://smith.langchain.com/settings/payments) page under Settings. Depending
...
rate limited to a maximum of 5,000 traces per month. You setup billing by:

1. Heading to the [Usage and Billing](https://smith.langchain.com/settings/payments) page under Settings
...
4. Claiming free credits as a thank you for being an early LangSmith user
