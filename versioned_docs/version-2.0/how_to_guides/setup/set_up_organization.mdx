...
See the table below for details on which features are available in which scope and plans:

| Resource/Setting                                                              	| Scope        	| Plan(s)                   	|
|-------------------------------------------------------------------------------	|--------------	|---------------------------	|
| Trace Projects                                                                	| Workspace    	| All                       	|
| Annotation Queues                                                             	| Workspace    	| All                       	|
| Deployments                                                                   	| Workspace    	| All                       	|
| Datasets &amp; Testing                                                        	| Workspace    	| All                       	|
| Prompts                                                                       	| Workspace    	| All                       	|
| API Keys                                                                      	| Workspace    	| All                       	|
| Settings including Secrets, Feedback config, Models, Rules, and Shared URLs # 	| Workspace    	| All                       	|
| Data Retention, Usage Limits                                                  	| Workspace*   	| All                       	|
| Plans and Billing, Credits, Invoices                                          	| Organization 	| All                       	|
| User management: Invite User to Organization                                  	| Organization 	| All                       	|
| User management: Invite User to Workspace                                     	| Workspace    	| Plus, Startup, Enterprise 	|
| RBAC: Assigning Workspace Roles                                               	| Workspace    	| Enterprise                	|
| Adding Workspaces                                                             	| Organization 	| Plus, Startup, Enterprise 	|
| Assigning Organization Roles                                                  	| Organization 	| Plus, Startup, Enterprise 	|
| RBAC: Creating/Editing Custom Roles                                           	| Organization 	| Enterprise                	|
