...
:::note
LangSmith is required by law to collect Tax ID information for reporting purposes in applicable jurisdictions. Entering your Tax ID ensures that your business transactions are accurately recorded and reported. Without your Tax ID, LangSmith might be required to withhold a percentage of payments for tax purposes.
:::
