...
You can use custom TLs certificates to connect to model providers in the LangSmith playground. This is useful if you are using a self-signed certificate or a certificate from a custom certificate authority.
