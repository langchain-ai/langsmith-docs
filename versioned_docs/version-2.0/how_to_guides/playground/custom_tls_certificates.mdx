...
To use custom TLS certificates, you need to set the following environment variables. See the [self hosted deployment section](../../category/self_hosting) for more information on how to set up application configuration.
