...
![answer_eval_flow.png](./static/answer_eval_flow.png)
...
![answer_hallucination_flow.png](./static/answer_hallucination_flow.png)
...
![document_relevance_flow.png](./static/document_relevance_flow.png)
...
This allows us to use them as online evaluators.
