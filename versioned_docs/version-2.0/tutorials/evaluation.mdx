...
- How many data-points should I gather?
- How should I gather those data-points?
...
After starting with these data-points, these datasets are generally _living_ constructs and grow over time.
...
For this tutorial, we will create 5 data-points to evaluate on.
...
This will be a little easier - we can define a simple Python to measure the length of the response.
...
For example - the data-points you will want to evaluate on will likely continue to change over time.
