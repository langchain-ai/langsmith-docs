...
For conceptual background, you can read:
...
LangSmith charges differently based on a traces' data retention (see our [data retention conceptual docs](../../concepts/usage_and_billing/data_retention_billing)),
