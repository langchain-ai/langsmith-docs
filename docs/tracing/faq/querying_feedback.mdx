...
<CodeTabs
    tabs={[
        PythonBlock(`correctness_feedback = client.list_feedback(feedback_key=["correctness"])`),
...
<CodeTabs
    tabs={[
        PythonBlock(`model_feedback = client.list_feedback(feedback_source_type=["model"])`),
