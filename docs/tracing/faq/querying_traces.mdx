...
<CodeTabs
  ...
  groupId="client-language"
/>
#### Complex query: List all "chain" type runs that took more than 10 seconds and
...
<CodeTabs
  ...
  groupId="client-language"
/>
#### Complex query: List all runs that started after a specific timestamp and either
...
client.listRuns({
  ...
  groupId="client-language"
/>
#### Check for environment details in metadata A common pattern is to add environment
...
<CodeTabs
  ...
  groupId="client-language"
/>
#### Check for conversation ID in metadata Another common way to associate traces
...
<CodeTabs
  ...
  groupId="client-language"
/>
#### Combine multiple filters to refine your search If you want to combine multiple
conditions to refine your search, you can use the `and` operator along with other
