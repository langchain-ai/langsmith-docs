---
sidebar_label: Collecting Feedback for Traces
sidebar_position: 4
---
...
### Collecting feedback programmatically
...
LangSmith allows you to manually annotate traces with feedback within the application. This can be useful for adding context to a trace, such as a user's comment or a note about a specific issue. You can annotate a trace either inline or by sending the trace to an Annotation Queue, which allows