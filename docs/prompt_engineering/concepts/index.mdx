...
For conditional mustache prompt:
...
:::tip Mustache format
LangSmith Playground uses f-string as default Template format,
but you can switch to Mustache format through Prompt Setting - Template Format setting.
It gives your more flexbility around conditional variables, loops, and nested keys.
For conditional variables, you might need to manually edit json variables in 'inputs' section.
