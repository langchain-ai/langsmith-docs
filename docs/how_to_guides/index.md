...
- [Prompt tags](./prompts/prompt_tags)
  - [Create a tag](./prompts/prompt_tags#create_a_tag)
  - [Move a tag](./prompts/prompt_tags#move_a_tag)
  - [Delete a tag](./prompts/prompt_tags#delete_a_tag)
  - [Using tags in code](./prompts/prompt_tags#using_tags_in_code)
  - [Common use cases](./prompts/prompt_tags#common_use_cases)
