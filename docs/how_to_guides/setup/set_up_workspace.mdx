...
When you log in for the first time, a default [workspace](../../concepts/admin#workspaces) will be created for you automatically in your [personal organization](./set_up_organization#personal-vs-shared-organizations).  
