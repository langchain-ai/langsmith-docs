...
3. LangSmith Version
    1. We default to the latest version of LangSmith. In a production environment, you may want to specify a specific version. Contact us at <a href="mailto:support@langchain.dev">support@langchain.dev</a> for more information.
...
You can find the `docker-compose.yml` file in the LangSmith SDK at the following here: [LangSmith Docker Compose File](#https://github.com/langchain-ai/langsmith-sdk/blob/main/python/langsmith/cli/docker-compose.yaml)
...
4. What networking configuration is needed for the application?
...
5. What resources should we allocate to the application?
