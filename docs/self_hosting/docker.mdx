...
1. Ensure that you copy the `users.xml` file as well.
...
_LANGSMITH_IMAGE_VERSION=0.1.17 # Change to your desired LangSmith version. Required. Typically you should use the latest version defined in the .env file.
