...
:::note
**Reminder: API keys prefixed with `ls__` will be disabled in favor of `lsv2...` style keys as of LangSmith Helm release v0.8 to be released in October 2024.** For more information see [the Admin concepts guide.](https://docs.smith.langchain.com/administration/concepts#api-keys)
:::
