...
- Added support for custom TLS certificates for the for the Azure OpenAI model provider. See the [how-to guide](./configuration/custom_tls_certificates) for more details.
