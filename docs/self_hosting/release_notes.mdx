...
- Added new Role-Based Access Controls. For more details see the [Admin](../administration/concepts) and [Set Up Access Control](../how_to_guides/setup/set_up_access_control) sections of the docs.
