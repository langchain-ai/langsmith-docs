...
This [reference doc](../reference/data_formats/feedback_data_format) explains the format we use to store feedback, which is the LangSmith's way of representing evaluation scores and annotations on runs.
