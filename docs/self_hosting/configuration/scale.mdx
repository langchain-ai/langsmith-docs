...
The table below contains high level guidance for LangSmith configurations, wherescale is measured in terms of traces per second (TPS). The configuration recommendations also assume that you are using a relatively new version of the SDK and LangSmith (at least `0.10.69`). It is strongly recommended to run high load against a Kubernetes deployment of LangSmith. 
...
| ------------------------------- | ------------------ | ----------------- | ------------------------- | ------------------------------- | ---------------- |
| [**10 TPS**](#10-traces-per-second-tps)                      | 3 (default)        | 1 (default)       | 3 (default)               | 4 vCPUs, 16 GB Memory (default) | 2 GB (default)   |
| [**100 TPS**](#100-tps)                     | **10**             | **2**             | 3 (default)               | 4 vCPUs, 16 GB Memory (default) | **13+ GB**       |
| [**1000 TPS**](#1000-tps)                    | **170**            | **4**             | **20**                    | **10 vCPUs, 48 GB Memory**      | **200+ GB**      |
...
The [default LangSmith configuration](../installation/kubernetes#prerequisites) can handle 10 TPS.
