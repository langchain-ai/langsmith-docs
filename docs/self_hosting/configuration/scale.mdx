...
| Load Pattern (Reads/Writes)                      | Concurrent Frontend Users | Traces Submitted per Second | Frontend Replicas | Platform Backend Replicas | Queue Replicas | Backend Replicas | Redis Resources  | ClickHouse Resources        | ClickHouse Setup              | Blob Storage |
| ------------------------------------------------ | ------------------------- | --------------------------- | ----------------- | ------------------------- | -------------- | ---------------- | ---------------- | --------------------------- | ----------------------------- | ------------ |
| **[Low/Low](#low-reads-low-writes)**             | 5                         | 10                          | 1 (default)       | 3 (default)               | 3 (default)    | 2 (default)      | 8 Gi (default)   | 4 CPU, 16 Gi (default)      | Single instance               | Disabled     |
| **[Low/High](#low-reads-high-writes)**           | 5                         | 1000                        | 4                 | 20                        | 160            | 5                | 200+ Gi external | 10 CPU, 32Gi memory         | Single instance               | Enabled      |
| **[High/Low](#high-reads-low-writes)**           | 50                        | 10                          | 2                 | 3 (default)               | 6              | 40               | 8 Gi (default)   | 8 CPU, 16 Gi per replica    | **3-node replicated cluster** | Enabled      |
| **[Medium/Medium](#medium-reads-medium-writes)** | 20                        | 100                         | 2                 | 3 (default)               | 10             | 16               | 13Gi external    | 16 CPU, 24Gi memory         | Single instance               | Enabled      |
| **[High/High](#high-reads-high-writes)**         | 50                        | 1000                        | 4                 | 20                        | 160            | 50               | 200+ Gi external | 14+ CPU, 24+ Gi per replica | **3-node replicated cluster** | Enabled      |
