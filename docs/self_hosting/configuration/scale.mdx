...
| **1000 TPS**                    | **170**            | **4**             | **20**                    | **9 vCPUs, 36 GB Memory**       | **200+ GB**      |
...
:::
:::important
The configuration recommendations also assume that you are using a relatively new version of the SDK and LangSmith (>`0.10.69`). If you haven't updated in a while, please do so. We are constantly pushing performance improvements, and will keep this page updated accordingly.
:::
...
- 9 vCPU and 32 GB of memory on your clickhouse instance.
- 170 queue pods
- 20 platform-backend pods
- 4 frontend pods. We use these as a reverse proxy for inbound requests.

Scaling up to this level will require roughly 218 vCPUs and 345 GB of memory for the pods in your kubernetes cluster.
