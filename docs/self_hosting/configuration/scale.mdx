...
:::note
Note that to move to a 200 GB Redis cache on Azure, you will have to move to a Redis Enterprise cluster. More information about enabling Redis cluster for LangSmith to come.
:::
