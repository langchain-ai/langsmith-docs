...
This means that you have a very high scale of trace ingestions, but single digit number of users on the frontend querying traces at any once time.
...
clickhouse:
  external:
    # Each replica in the cluster should have resource requests of 8 cores and 16 GB memory, and resource limit of 12 cores and 32 GB memory.
    enabled: true
