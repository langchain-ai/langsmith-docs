...
and set the blob storage [container](https://learn.microsoft.com/en-us/azure/storage/blobs/storage-blobs-introduction#containers) (listed in order of precedence):
...
<CodeTabs
  ...
  config:
   ...
   backend: # Optional, only required if using IAM role for service account on AWS
     serviceAccount:
       annotations:
         eks.amazonaws.com/role-arn: "<role_arn>" \n
   platformBackend: # Optional, only required if using IAM role for service account on AWS
      serviceAccount:
        annotations:
          eks.amazonaws.com/role-arn: "<role_arn>" \n
   queue: # Optional, only required if using IAM role for service account on AWS
      serviceAccount:
        annotations:
          eks.amazonaws.com/role-arn: "<role_arn>"
      `),
