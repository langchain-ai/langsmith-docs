...
:::info
For an example setup of a replicated ClickHouse cluster, check out the [replicated ClickHouse section](https://github.com/langchain-ai/helm/blob/main/charts/langsmith/examples/replicated-clickhouse/README.md) in the LangSmith Helm chart repo, under examples.
:::
...
For more information, check out the dedicated page for [managed ClickHouse](/self_hosting/langsmith_managed_clickhouse)
