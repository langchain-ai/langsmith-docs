...
The [LangChain Hub](https://smith.langchain.com/hub) lets you discover, version control, and experiment with different prompts for LangChain and LLMs in general directly in your browser.

### How do I share a private prompt with my team?
...
Then, you can upload prompts to the organization:

```python
from langchain import hub

prompt = ...
hub.upload("my-organization/my-prompt-name", prompt, new_repo_is_public=False)
```

All other members of your organization will be able to view, pull, and open the prompt in the playground.
