...
:::note
SCIM is available for organizations on the [Enterprise plan](https://www.langchain.com/pricing-langsmith). Please [contact sales](https://www.langchain.com/contact-sales) to learn more.
:::
...
| `name.formatted`               | `displayName` OR `Join(" ", [givenName], [surname])`\*\* |                         |
...
- Groups must follow the naming convention described in the [Azure Group Naming Convention](#azure-group-naming-convention) section
