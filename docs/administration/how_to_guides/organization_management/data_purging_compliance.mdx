...
Trace deletes can be done self-serve via our API. The API supports two methods for deleting traces:
...
Link To API Spec: https://api.smith.langchain.com/redoc#tag/run/operation/delete_runs_api_v1_runs_delete_post
