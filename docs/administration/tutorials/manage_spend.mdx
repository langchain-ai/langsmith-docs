...
Navigate to **Projects** > ***Your project name*** > Select **Retention** and modify the default rentetion of the project to **Base**. This will only affect retention (and pricing) for **traces going forward**.
...
- 10% of all traces: For general analysis or long-term trends
