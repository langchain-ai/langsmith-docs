...
use this feature, please read more about its functionality [here](/administration/concepts/usage_and_billing/usage_limits#side-effects-of-extended-data-retention-traces-limit).
:::
