...
In order to facilitate this, LangSmith has built out a series of functionalities related to production monitoring and automations.
This includes support for easily exploring and visualizing aggregations of metrics, as well as support for defining automations to act upon the data.

To get started, check out the [Quick Start Guide](/monitoring/quick_start).

After that, peruse the [Concepts Section](/monitoring/concepts) to better understand the different components involved with tracing.
