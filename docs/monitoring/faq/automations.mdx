...
![Create filter](/monitoring/static/filter_rule.png)
...
![Sampling rate](/monitoring/static/automations.png)
...
![Manage Automations](/monitoring/static/manage_automations.png)
