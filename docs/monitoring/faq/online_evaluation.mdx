...
One of the actions you can set up as part of an automation is online evaluation. This involves running an LLM over a datapoint.
...
![Subsets Monitor](/monitoring/static/filter_rule.png)

From here, you can can select `Online Evaluation` from the list of possible actions

![Subsets Monitor](/monitoring/static/automations.png)
...
![Subsets Monitor](/monitoring/static/evaluator.png)
