...
<br />
<sup>2</sup> You can purchase LangSmith credits for your tracing usage. As long as you have a valid credit card in your account, we’ll service your traces and deduct from your credit balance. You’ll be able to set alerts and auto top-ups on credits if you choose.  
<br />
<sup>3</sup> Personal accounts without a credit card on file will be rate limited to 50,000 ingested events per hour and 500MB of storage per hour.
<br />
<sup>4</sup> Trace storage includes all submitted inputs, outputs, and metadata and is aggregated over all submission events.  Depending on the design of your application, trace data may be sent multiple times (e.g. once at the start of a trace step and again after it is complete)
