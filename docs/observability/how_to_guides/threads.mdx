...
- [Add metadata and tags to traces](./add_metadata_tags)
...
You can [add metadata to your traces](./add_metadata_tags) in LangSmith in a variety of ways, this code will show how to do so dynamically, but read the
...
### Get the last run in a thread

You may want to run evaluations over a multi-turn conversation
