...
2. Setup environment variables for the endpoint, substitute your specific values:
   ...
   If you're self-hosting LangSmith, replace the base endpoint with your LangSmith service endpoint and append `/api/v1`. For example: `OTEL_EXPORTER_OTLP_ENDPOINT=https://ai-company.com/api/v1/otel`
   :::
