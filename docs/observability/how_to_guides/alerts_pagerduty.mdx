...
:::info
LangSmith deduplicates alerts by alert rule, trace project, and hourly time bucket. This helps reduce noise and avoid duplicate incidents within the same context.
:::
...
- Check if the alerts was within the 1 hour window from previous trigger and filtered by deduplication 
