...
### Step 3: Save the Integration Key as a Workspace Secrets

As a best pratice, we reccomend saving the Integration Key as a Workspace Secret. This will allow you to re-use the same key across alerts for a workspace.

1. Navigate to the **Settings** page
2. Select the **Secrets** tab
3. Click **Add secret**
4. Enter a name for the secret (e.g., "PagerDuty Integration Key")
5. Paste the Integration Key from Step 2 into the value field
6. Click **Save secret**

### Step 4: Configure LangSmith Alert with PagerDuty
...
2. Click the Key icon and select the secret you created in Step 3
