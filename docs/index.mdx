...
If following along with code is more your thing, we've set up [a Jupyter notebook at this link](https://python.langchain.com/docs/langsmith/walkthrough) to help you get started with LangSmith.
:::
<>
  <div
    style={{
