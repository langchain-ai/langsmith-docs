...
If following along with code is more your thing, we've set up this [Jupyter notebook](https://github.com/langchain-ai/langchain/blob/master/docs/docs/guides/langsmith/walkthrough.ipynb) to help you get started with LangSmith.
:::
<>
  <div
    style={{
  ...
  >
    <iframe
      src="https://www.loom.com/embed/b8e1027ffe174830b119121de1b020f1?sid=6a554cf3-b83f-40bb-addd-4dca66440231"
      frameBorder={0}
