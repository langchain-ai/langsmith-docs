...
# For more info on the evaluator format, see: https://docs.smith.langchain.com/evaluation/how_to_guides/evaluation/evaluate_llm_application#use-custom-evaluators
...
const score = rootRun.outputs?.outputs.length > example.outputs?.answer.length;
