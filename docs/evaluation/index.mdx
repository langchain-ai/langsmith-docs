  ...
  <CodeTabs
    tabs={[
      ...
      },
      {
        ...
        label: "yarn",
        language: "bash",
        caption: "\`@langchain/core\` is used internally as a peer dep for \`openevals\` evaluators - it is not required for LangSmith evals in general.",
      ...
      },
      {
        ...
        label: "pnpm",
        language: "bash",
        content: `pnpm install langsmith openevals openai`,
      },
    ]}
