...
![](./how_to_guides/static/view_experiment.gif)
  ...
  ## 1. Navigate to the Playground
    LangSmith's [Prompt Playground](/prompt_engineering/concepts#prompt-playground) makes it possible run evaluations over diffrent prompts, new models or test different model configuration. Go to LangSmith's **Playground**. 
...
:::tip
To learn more about running experiments in LangSmith, read conceptual the [evaluation conceptual guide](./evaluation/concepts).
:::
