...
Repetitions can be confiigured by passing the `num_repetitions` argument to `evaluate` / `aevaluate` ([Python](https://docs.smith.langchain.com/reference/python/evaluation/langsmith.evaluation._runner.evaluate), [TypeScript](https://langsmith-docs-bdk0fivr6-langchain.vercel.app/reference/js/interfaces/evaluation.EvaluateOptions#numrepetitions)).
