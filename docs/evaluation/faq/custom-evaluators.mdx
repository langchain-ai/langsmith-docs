...
Some metrics can only be defined on a higher, dataset level. For example, you may want to compute the f1 score of a classifier across all runs in a dataset. These are called `summary_evaluators`.
