...
In this section, you will create a LangChain string evaluator that grades the relevance of a model's response to the input. You can also consult the [reference documentation](https://api.python.langchain.com/en/latest/langchain_api_reference.html#module-langchain.smith) for more details.
