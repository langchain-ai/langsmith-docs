...
<p>The <code>evaluate()</code> method calls your `predict()` function on each example in the dataset. It traces this process and provides the traces and examples to your [evaluators](faq/custom-evaluators), which return scores for each prediction.</p>
