...
LangSmith helps you evaluate any AI systems
...
<p>LangSmith provides a convenient `evaluate()` method to generate predictions (and traces) over a dataset. When evaluators are provided, they will also be called to generate automated feedback.</p>
