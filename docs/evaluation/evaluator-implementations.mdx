...
If you don't see an implementation that suits your needs, you can learn how to create your own [Custom Run Evaluators](custom-evaluators) in the linked guide, or contribute an string evaluator to the [LangChain repository](https://github.com/hwchase17/langchain/blob/master/langchain/evaluation/).
...
run_on_dataset(
    client,
    "<dataset_id>",
    <LLM or constructor for chain or agent>,
...
We'd love feedback and contributions! Send us feedback at support@langchain.dev, check out the [Evaluators](https://github.com/hwchase17/langchain/tree/master/langchain/evaluation) in LangChain or submit PRs or issues directly to better address your needs.
