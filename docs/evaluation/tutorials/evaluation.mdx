...
For more information on the evaluation workflows LangSmith supports, check out the [how-to guides](../../evaluation/how_to_guides), or see the reference docs for [evaluate](https://langsmith-docs-git-bagatur-rfcbuiltinsdkref-langchain.vercel.app/reference/python/evaluation/langsmith.evaluation._runner.evaluate) and its asynchronous [aevaluate](https://langsmith-docs-git-bagatur-rfcbuiltinsdkref-langchain.vercel.app/reference/python/evaluation/langsmith.evaluation._arunner.aevaluate) counterpart.
