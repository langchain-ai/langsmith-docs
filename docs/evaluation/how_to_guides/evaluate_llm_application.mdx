...
:::tip
You can also check out [openevals](https://github.com/langchain-ai/openevals) and [agentevals](https://github.com/langchain-ai/agentevals) for readymade evaluators.
:::
