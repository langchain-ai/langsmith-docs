...
:::warning Warning
These evaluators are outdated, we are working on creating new prebuilt evaluators from the `LLMEvaluator` class.
To learn more about `LLMEvaluator`, read [this how-to](./use_llm_evaluator_interface)
:::
