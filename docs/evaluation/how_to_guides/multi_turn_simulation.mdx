...
Instead of evaluating over static trajectories in your dataset, you may find it useful to instead run a *simulation* between your app and a user, then evaluate this dynamically
