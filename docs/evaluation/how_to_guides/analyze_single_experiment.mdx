...
- **Control decimal precision on feedback scores**. By default, we surface numerical feedback scores with a decimal precision of 2, but you can customize this setting to be up to 6 decimals
...
![Column heatmap configuration](./static/column_heat_map.png)
