...
If your run had attachments, you can also manage these from the same pane before adding the run to the dataset:

![](./static/add_attachments_to_example_from_run.png)
