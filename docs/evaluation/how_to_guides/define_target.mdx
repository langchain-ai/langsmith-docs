...
This means that if you run any traceable code within your target function, this will also be traced as child runs of the target function.
...
## Example: non-LLM component of your system
...
- Execution of a tool (for example a research tool)

In this example we will show how to test a simple calculator tool. In practice 
