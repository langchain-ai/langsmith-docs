...
Using LLM-as-a-judge evaluators can be very helpful when you can't evaluate your system programmatically. However, LLM-as-a-judge evaluators require their own prompts, and iterating on these prompts adds overhead to the development process. You now need to prompt engineer both your application **and** your evaluators. To make this easier, 
LangSmith helps you align LLM-as-a-judge evaluators to human preferences by turning [human corrections](/evaluation/how_to_guides/create_few_shot_evaluators#make-corrections) into few-shot examples for your evaluator.
