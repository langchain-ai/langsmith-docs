...
Running multiple [repetitions](/evaluation/concepts#repetitions) can given a more accurate estimate of the performance of your system since LLM outputs are not deterministic and can differ from one repetition to the next. Repetitions are a way to reduce
