...
- You want to take advantage of mocks, watch mode, local results, or other features of the Jest/Vitest ecosystem
...
You can now define evals as tests using familiar Jest/Vitest syntax, with a few caveats:
