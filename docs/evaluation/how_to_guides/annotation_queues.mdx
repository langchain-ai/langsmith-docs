...
4. Select one or multiple experiments from the dataset page that you want a human to review and click "Annotate". From the resulting popup, you may either create a new queue or add to an existing one:
